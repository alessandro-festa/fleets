...
|-----------|------|---------|-----------|--------|
| argo-workflows | Helm | * | myrecipe | argo-workflows (oci://dp.apps.rancher.io/charts/argo-workflows) |
| vllm | Helm | * | myrecipe | vllm (oci://dp.apps.rancher.io/charts/vllm) |
| nemo-guardrails | Helm | 25.6.0 | myrecipe | nemo-guardrails (https://helm.ngc.nvidia.com/nvidia/nemo-microservices/charts/nemo-guardrails-25.6.0.tgz) |
...
```bash
helm uninstall nemo-guardrails -n myrecipe
```
```bash
